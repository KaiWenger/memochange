...
#'
#' The memochange package is a collection of test procedures
#' and break point estimators for persistent processes
#' that exhibit structural breaks in mean or in persistence.
#'
#' @docType package
